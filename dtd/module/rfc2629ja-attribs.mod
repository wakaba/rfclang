...
<!-- file: rfc2629ja-attribs.mod
     ...
     This DTD module is identified by the SYSTEM identifier:
       ...
       SYSTEM "http://suika.fam.cx/gate/cvs/*checkout*/markup/rfc/dtd/module/rfc2629ja-attribs.mod"
