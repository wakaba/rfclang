...
<!-- file: myns-datatype.mod
     ...
     This DTD module is identified by the SYSTEM identifier:
       ...
       SYSTEM "http://suika.fam.cx/gate/cvs/*checkout*/markup/rfc/dtd/module/myns-datatype.mod"
...
<!ENTITY % myns.yesno.datatype "(yes|no)">


<!-- end of myns-datatype.mod -->
